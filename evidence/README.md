...
> **Status:** this evidence is being regenerated against a fresh deployment
> now that Task 6 has a real, working implementation (see
> `docs/PROJECT_PLAN.md` §18) instead of the AWS-SDK-gap workaround the old
> evidence documented. Files below are filled in as each piece is captured.
